    ...
    try {
      ...
      if (["approved", "rejected", "pending"].includes(data.status)) {
        ...
        switch (data.status) {
          case "approved":
            setMessage(
              "Your store has been approved. You can now add products to your store",
            );
          ...
          case "rejected":
            setMessage(
              "Your store request has been approved. Contact admin for detail",
            );
            break;

          case "pending":
            setMessage(
              "Your store request is pending, wait for admin approval",
            );
            break;
